...
Auto.prototype.getPatente = function(){console.log(this.patente)};
...
Camion.prototype.cargarCamion = function(pesoMaximo,pesoAuto,auto){ 

if (this.pesoMaximo-pesoAuto > 0 && this.pesoCurrent < this.pesoMaximo){
	pesoCurrent=pesoMaximo-pesoAuto;
	console.log(pesoCurrent);
	this.AutosCargados.push(auto);
}
else (alert("Peso sobrepasado"))
};
...
camion1.pesoCurrent=0;
//camion1.AutosCargados=[[100,"AAA"],[140,"BBB"]];


camion1.cargarCamion(camion1.pesoCurrent,auto1.peso,auto1);
camion1.cargarCamion(camion1.pesoMaximo,auto2.peso,auto2);
camion1.cargarCamion(camion1.pesoMaximo,auto3.peso,auto3);
camion1.cargarCamion(camion1.pesoMaximo,auto4.peso,auto4);
camion1.listarCarga();
